...
namespace Ragans
{
    internal class ProcessMemory
    {
        ...
        public void WriteMem(int pOffset, int pSize, bool v)
        {
            int bytesWritten = 0;
            var value = new byte[] { 1 };
            WriteProcessMemory(new IntPtr(this.processHandle), new IntPtr(pOffset), value, (uint)pSize, out bytesWritten);

        }

        public void WriteMem(int pOffset, int pSize, long v)
        {
            int bytesWritten = 0;
        ...
        public void WriteMem(int pOffset, int pSize, int v)
        {
            int bytesWritten = 0;
        ...
        public void WriteMem(int pOffset, int pSize, byte[] value)
        {
            int bytesWritten = 0;
            //var value = new byte[] { (byte)v };
            WriteProcessMemory(new IntPtr(this.processHandle), new IntPtr(pOffset), value, (uint)pSize, out bytesWritten);
        ...
        public uint WriteFloat(int pOffset, float value)
        {
            WriteMem(pOffset, sizeof(float), BitConverter.GetBytes(value));
            return 0;
        }
        ...
        public uint WriteBool(int pOffset, bool value)
        {
            WriteMem(pOffset, sizeof(byte), value);
            return 1;
        }
